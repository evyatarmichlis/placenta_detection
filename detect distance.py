...
class PlacentaImageUploader:
    ...
    def display_live_preview(self):
        while True:
            ...
            cv2.circle(display_frame, center_coordinates, Consts.circle_radius, Consts.circle_color, Consts.circle_thickness)
            ...
            cv2.putText(display_frame, text_line1, org_line1, Consts.font, Consts.font_scale, Consts.font_color, Consts.font_thickness, cv2.LINE_AA)
            cv2.putText(display_frame, text_line2, org_line2, Consts.font, Consts.font_scale, Consts.font_color, Consts.font_thickness, cv2.LINE_AA)
            ...
            if key == 13:  # Enter key
                ...
                result = messagebox.askyesno("Confirmation", "Are you sure you want to upload this image to the database?")
                if result:
